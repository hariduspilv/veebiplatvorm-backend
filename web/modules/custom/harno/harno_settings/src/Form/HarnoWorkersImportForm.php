  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['csv_file'] = [
      ...
      '#description' => [
        ...
        '#description' => 'CSV fail peab sisaldama veerge järgmises järjekorras: ' . implode(", ",$this->columns),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    foreach ($data as $i => $row) {
      ...
      foreach ($row_departments as $j => $rd) {
        ...
        $department_id = $departments_term_query->execute();
      ...
      foreach ($row_positions as $j => $rp) {
        ...
        $position_id = $positions_term_query->execute();
          ...
          if (empty($node_id)) {
            $node = Node::create(
              [
                'type' => 'worker',
                'title' => $name,
                'field_position' => reset($positions_array),
